...
nmap <silent> ,r :CtrlPBuffer
nmap <silent> ,y :NERDTreeFind
nmap <silent> ,k :NERDTreeToggle
map ,wc :wincmd q
map ,ev :e! ~/.vimrc " edit ~/.vimrc
nmap \s :set ts=4 sts=4 sw=4 et
nmap \t :set ts=4 sts=4 sw=4 noet
...
map <C-L> :call WinMove('l')
map <C-K> :call WinMove('k')
map <C-J> :call WinMove('j')
map <C-H> :call WinMove('h')
vmap <BS> "-d
vmap <D-x> "*d
vmap <D-c> "*y
vmap <D-v> "-d"*P
...
set runtimepath+=~/.vim/bundle/vim-preview
set runtimepath+=~/.vim/bundle/emmet-vim
set runtimepath+=~/.vim/bundle/vim-gnupg
set runtimepath+=~/.vim/bundle/vim-ruby-runner
set runtimepath+=~/.vim/bundle/YouCompleteMe
set runtimepath+=~/.vim/bundle/vim-ruby
set runtimepath+=~/.vim/bundle/vim-rails
set runtimepath+=~/.vim/bundle/vim-anyfold
...
set runtimepath+=/opt/homebrew/share/vim/vim82
...
set runtimepath+=~/.vim/bundle/vimux/after
...
set runtimepath+=~/.vim/bundle/vim-notes/after
set runtimepath+=~/.vim/bundle/vim-misc/after
set runtimepath+=~/.vim/bundle/vimtex/after
set runtimepath+=~/.vim/bundle/vim-preview/after
set runtimepath+=~/.vim/bundle/emmet-vim/after
set runtimepath+=~/.vim/bundle/vim-gnupg/after
set runtimepath+=~/.vim/bundle/vim-ruby-runner/after
...
set runtimepath+=~/.vim/bundle/vim-anyfold/after
...
set runtimepath+=~/.vim/bundle/vim-javascript-syntax/after
set shiftround
set shiftwidth=4
...
silent only
silent tabonly
cd ~/Library/Mobile\ Documents/com~apple~CloudDocs/Files/Development/learning-python/python-terminal-prompt-test
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 terminal-prompt-test.py
argglobal
%argdel
$argadd terminal-prompt-test.py
edit terminal-prompt-test.py
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
